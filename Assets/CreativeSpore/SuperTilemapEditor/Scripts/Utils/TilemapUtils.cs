...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public static class TilemapUtils
    {
        ...
        /// </summary>
        public static UnityEngine.Sprite GetOrCreateTileSprite(Tileset tileset, int tileId, float pixelsPerUnit = 0)
        {
            ...
            if (tile != null)
            {
                ...
                {
                    sprite = UnityEngine.Sprite.Create(tileset.AtlasTexture, spriteUV, new Vector2(.5f, .5f), pixelsPerUnit);
