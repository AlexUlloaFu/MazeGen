...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class TileObjectBehaviour : MonoBehaviour 
    {
        ...
        {
            UnityEngine.Sprite tileSprite = GetOrCreateSprite(data);
            if (tileSprite)
            {                
        ...
        private static Dictionary<string, UnityEngine.Sprite> s_spriteCache = new Dictionary<string, UnityEngine.Sprite>();
        public static UnityEngine.Sprite GetOrCreateSprite(TilemapChunk.OnTilePrefabCreationData data)
        {
            ...
            if (tile != null)
            {
                ...
                {
                    sprite = UnityEngine.Sprite.Create(data.ParentTilemap.Tileset.AtlasTexture, spriteUV, new Vector2(.5f, .5f), pixelsPerUnit);
